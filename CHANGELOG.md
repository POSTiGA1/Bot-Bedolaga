...
## [5.0.0](https://github.com/POSTiGA1/Bot-Bedolaga/compare/v4.11.0...v5.0.0) (2026-09-14)
...
* **admin:** add Bedolaga-first User Detail contracts ([57e2794](https://github.com/POSTiGA1/Bot-Bedolaga/commit/57e2794f55ba8cff918ff5c622bb6bbf9df9afb5))
...
* **auth:** add system-wide invite-only registration ([b639273](https://github.com/POSTiGA1/Bot-Bedolaga/commit/b639273dfd1783f6aac09b16241b1a6efee726eb))
...
* **cabinet:** панельная идентичность и контракты под 3.0.0 ([2b97440](https://github.com/POSTiGA1/Bot-Bedolaga/commit/2b9744049dcfce6677e44442490202f08b31b0a9))
...
* **cabinet:** согласие с офертой и политикой при первой авторизации ([3b0306f](https://github.com/POSTiGA1/Bot-Bedolaga/commit/3b0306fae60ac2ad905d6c10c35402167d983902))
...
* **config:** TRAFFIC_EXCLUDED_USER_UUIDS переименован в _USER_IDS ([88a92f7](https://github.com/POSTiGA1/Bot-Bedolaga/commit/88a92f794267f599bba993811119cccba72fb2f7))
* **coupons:** лимит активаций на пользователя и удаление партий ([8260944](https://github.com/POSTiGA1/Bot-Bedolaga/commit/82609441ae29e24d9037ce77b8299836a6ec8844))
* **db:** числовая панельная идентичность remnawave_id ([898bcf4](https://github.com/POSTiGA1/Bot-Bedolaga/commit/898bcf49bcb829e54a02808c0af1055216d81837))
* **devices:** запрет уменьшать лимит устройств ниже включённого в тариф ([8aafb64](https://github.com/POSTiGA1/Bot-Bedolaga/commit/8aafb648b97830aabf885eda47954f92fe888a6f))
...
* **remnawave:** бэкфил панельной идентичности ([b97e5f6](https://github.com/POSTiGA1/Bot-Bedolaga/commit/b97e5f6bbfa7bf792b06f4ac181e214cec5da96c))
* **remnawave:** клиент API под 3.0.0 ([c763514](https://github.com/POSTiGA1/Bot-Bedolaga/commit/c763514324c45aff3193631cc4c344873c3ebc55))
...
* **remnawave:** сервисный слой на числовую идентичность ([6da10bc](https://github.com/POSTiGA1/Bot-Bedolaga/commit/6da10bcc94e2dbf37e7d646d48e3a3a018a60c4d))
* **remnawave:** хендлеры, миддлвари и Web API под 3.0.0 ([c897d38](https://github.com/POSTiGA1/Bot-Bedolaga/commit/c897d383ceb0177babc5f38ecca368899228bc0d))
...
* show payment methods directly on extend insufficient-balance screen ([45f81a8](https://github.com/POSTiGA1/Bot-Bedolaga/commit/45f81a89f3983441e391ebe699f0dfc34ce5bbb4))
* show payment methods directly on extend insufficient-balance screen ([00c66cf](https://github.com/POSTiGA1/Bot-Bedolaga/commit/00c66cfb71743dfd2beb34f3a205b40a8f7c9331))
* skip tariff selection screen when only one tariff is available ([5c74099](https://github.com/POSTiGA1/Bot-Bedolaga/commit/5c7409940cf975ea4748519cf4d54bb265702209))
* skip tariff selection screen when only one tariff is available ([935dbe3](https://github.com/POSTiGA1/Bot-Bedolaga/commit/935dbe3825d48b0b97395bf10127e59954223708))
* sort user list by soonest subscription expiry ([e3713ce](https://github.com/POSTiGA1/Bot-Bedolaga/commit/e3713ce9710dfa8d3fbfc1abf10b034378fd8978))
* sort user list by soonest subscription expiry ([f69a670](https://github.com/POSTiGA1/Bot-Bedolaga/commit/f69a67014027efe0acb7779ce40371f0d5330866))
...
* **webapi:** эндпоинт ручного пополнения баланса с идемпотентностью ([cd9811c](https://github.com/POSTiGA1/Bot-Bedolaga/commit/cd9811c18f679047a30c6c304ca99ab89f386cc6))
...
* **admin:** лог при пропуске синка панели у подписки без UUID ([3d77bc2](https://github.com/POSTiGA1/Bot-Bedolaga/commit/3d77bc20a621702ec2f0f3bd4f21a1f5a4a80a9e))
...
* **admin:** отмена рекуррента Lava при сбросе выбранной подписки ([2f2006a](https://github.com/POSTiGA1/Bot-Bedolaga/commit/2f2006a5d08289ccfb3c606d0cdb702ccd369ea7))
...
* back button leads to main menu when tariff selection was skipped ([a6e5c5a](https://github.com/POSTiGA1/Bot-Bedolaga/commit/a6e5c5a227fa1c6f5d79e00d1801a66d05756771))
...
* **grace:** сессия без панельного id чинится при чтении, а не живёт вечно ([5116848](https://github.com/POSTiGA1/Bot-Bedolaga/commit/51168487da3f51a256e59abe9655fcc8ebee0364))
...
* **notifications:** MissingGreenlet при уведомлении о регистрации по кампании ([0f1beff](https://github.com/POSTiGA1/Bot-Bedolaga/commit/0f1beff51b284bae0183bb37000b860e82b4ee4e))
...
* **notifications:** не отправлять отключённые уведомления пользователям ([22370a8](https://github.com/POSTiGA1/Bot-Bedolaga/commit/22370a804114e9514d28b47ca3b55635e12b07b1))
...
* **remnawave:** grace-сессия строки-донора не теряет идентичность ([dc09e78](https://github.com/POSTiGA1/Bot-Bedolaga/commit/dc09e78077d00c02b3dc3e16a4e846bcf1cbed30))
* **remnawave:** бэкфил не блокируется одной парой и отдаёт id живой строке ([5cd3adb](https://github.com/POSTiGA1/Bot-Bedolaga/commit/5cd3adb5bd856ca54d984bb4f9f59ce33a097b0d))
* **remnawave:** бэкфил не откатывался целиком на single-tariff ([d461784](https://github.com/POSTiGA1/Bot-Bedolaga/commit/d461784f3c70cb58c7dd11fc9c51b60be0190ae8))
...
* **remnawave:** бэкфилл падал на старте и брал не тот режим ([deeb24f](https://github.com/POSTiGA1/Bot-Bedolaga/commit/deeb24fbcdd235f63892b50d2ca478b2c6ac6325))
* **remnawave:** бэкфилл привязывал чужой аккаунт, создание падало на индексе ([98e63b0](https://github.com/POSTiGA1/Bot-Bedolaga/commit/98e63b07b5c8e8c562c1e96936049f057257d2d8))
* **remnawave:** вебхук не проверял соседей, и подписи тестов врали ([70d35c1](https://github.com/POSTiGA1/Bot-Bedolaga/commit/70d35c1afee123938ce833688120dc2397855d98))
* **remnawave:** защита от противоречивых uuid не работала на первом прогоне ([928ce20](https://github.com/POSTiGA1/Bot-Bedolaga/commit/928ce20a011618ee4793bc50c068eafde65e0946))
...
* **remnawave:** карта uuid не праймилась, холостой прогон писал в БД ([e9445ee](https://github.com/POSTiGA1/Bot-Bedolaga/commit/e9445ee2f12c811965e4936687258d79152c707a))
* **remnawave:** ложный успех при удалении устройств, окно суток и happ-ссылка ([b007de8](https://github.com/POSTiGA1/Bot-Bedolaga/commit/b007de8f4117d4626a03fd3c54316a1e34aaaee6))
...
* **remnawave:** не терять и не подсовывать протухшую идентичность подписки ([bef6e6d](https://github.com/POSTiGA1/Bot-Bedolaga/commit/bef6e6d7d1db65660800b58e7fc20856f40b0751))
* **remnawave:** несовпадение владельца снова вело к очистке, а не к перепривязке ([ea4db92](https://github.com/POSTiGA1/Bot-Bedolaga/commit/ea4db928b3d9dd171af3d00b8f9c706d4cc47fca))
* **remnawave:** повторный прогон бэкфила и выбор живой подписки ([b515c3d](https://github.com/POSTiGA1/Bot-Bedolaga/commit/b515c3d30bb762f89b425069d5685d8750168ce0))
* **remnawave:** поля, которых нет в контракте 3.0.0, и след прогона бэкфила ([babf846](https://github.com/POSTiGA1/Bot-Bedolaga/commit/babf84634d676a71e7c2b77f03ec7aadaefb391f))
* **remnawave:** порядок UPDATE'ов при переносе панельного id ([28b01f1](https://github.com/POSTiGA1/Bot-Bedolaga/commit/28b01f1ee71841a2d9654e357c26729f8a6f09af))
* **remnawave:** протухший id больше не решает за пользователя ([83c6415](https://github.com/POSTiGA1/Bot-Bedolaga/commit/83c6415c11d007151dde99dfea61178382ba1e8a))
...
* **remnawave:** след прогона врал, а защита индекса не мешала записи в панель ([fe3dc5b](https://github.com/POSTiGA1/Bot-Bedolaga/commit/fe3dc5bb42cef0b1becbaa56c6ad9be3076c9276))
* **remnawave:** суточная проверка снова не сработала бы, а граница id ослабла ([3c31285](https://github.com/POSTiGA1/Bot-Bedolaga/commit/3c31285a4c920b715dc57253c6525af82972a5b6))
* **remnawave:** точный ключ не должен проигрывать догадке и ронять синк ([d2fd3d5](https://github.com/POSTiGA1/Bot-Bedolaga/commit/d2fd3d5db91ed82aea639b5602dc9f900aeaa18b))
* **remnawave:** холостой прогон бэкфила называл свой отчёт «conflicts» ([6b7204b](https://github.com/POSTiGA1/Bot-Bedolaga/commit/6b7204b1d5cf5a1a6e4cffa9972aef9f55995500))
* **rich-menu:** RICH_MESSAGE_DATE_INVALID на подписках дальше ~3 лет ([9ee31d3](https://github.com/POSTiGA1/Bot-Bedolaga/commit/9ee31d3d57e5fcac58bb26886b256ab62fb6884b))
* **rich:** make usernames clickable ([42ff65a](https://github.com/POSTiGA1/Bot-Bedolaga/commit/42ff65a97b14f2d6cc88408785e74d9d5ee79ff2))
...
* **search:** регистронезависимый поиск по юзерам для кириллицы ([5323803](https://github.com/POSTiGA1/Bot-Bedolaga/commit/53238035f72b4a1ee7554196d0899e9bde23d6df))
...
* **settings:** осмысленные категории для настроек, начинающихся с глагола ([e6f1505](https://github.com/POSTiGA1/Bot-Bedolaga/commit/e6f150537ad57b24f95f9f7024d0d329c5cd6c56))
...
* устранить замечания CodeQL из PR [#3123](https://github.com/POSTiGA1/Bot-Bedolaga/issues/3123) ([c7cc8b4](https://github.com/POSTiGA1/Bot-Bedolaga/commit/c7cc8b4585b94766be87fd5a260ec8f436a5b7a8))
...
* **remnawave:** точное обоснование раздельных flush при переносе id ([6eb80c6](https://github.com/POSTiGA1/Bot-Bedolaga/commit/6eb80c6957987a48098bfffe2b11701dc4267285))
